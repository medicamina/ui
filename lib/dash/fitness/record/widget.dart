...
class MedicaminaDashFitnessRecordWidget extends StatefulWidget {
  ...
  @override
  State<MedicaminaDashFitnessRecordWidget> createState() =>
      _MedicaminaDashFitnessRecordWidgetState();
}

class _MedicaminaDashFitnessRecordWidgetState
    extends State<MedicaminaDashFitnessRecordWidget> {
  @override
                ...
                child: Column(
                  ...
                  children: [
                    IconButton(
                        onPressed: () {},
                        icon: Icon(
                            CommunityMaterialIcons.clipboard_clock_outline))
                  ],
                ),
              ),
            ],
