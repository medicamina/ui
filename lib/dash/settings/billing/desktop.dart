...
class MedicaminaDashSettingsBillingDesktopWidget extends StatefulWidget {
  const MedicaminaDashSettingsBillingDesktopWidget({Key? key})
      : super(key: key);

  @override
  State<MedicaminaDashSettingsBillingDesktopWidget> createState() =>
      _MedicaminaDashSettingsBillingDesktopWidget();
}

class _MedicaminaDashSettingsBillingDesktopWidget
    extends State<MedicaminaDashSettingsBillingDesktopWidget> {
  @override
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyle(
                                color: Modular.get<MedicaminaThemeState>()
                                        .getDarkMode()
                                    ? null
                                    : const Color.fromRGBO(87, 96, 106, 1),
                            ...
                            TextButton(
                                onPressed: () {},
                                child: const Text('Switch to yearly billing')),
