...
class MedicaminaAuthAppBarWidget extends StatefulWidget implements PreferredSizeWidget {
  ...
  @override
  State<MedicaminaAuthAppBarWidget> createState() => _MedicaminaAuthAppBarWidget();
...
class _MedicaminaAuthAppBarWidget extends State<MedicaminaAuthAppBarWidget> {
  static bool _loading = Modular.get<MedicaminaAuthAppBarLoadingState>().getLoading();
  static late StreamSubscription _streamSubscription;

  @override
  void initState() {
    super.initState();
    _streamSubscription = Modular.get<MedicaminaAuthAppBarLoadingState>().getStream().listen((value) {
      setState(() {
        _loading = value;
      });
    });
