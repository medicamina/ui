...
class MedicaminaDashEdictsScriptsWidget extends StatefulWidget {
  ...
  @override
  State<MedicaminaDashEdictsScriptsWidget> createState() => _MedicaminaDashEdictsScriptsWidgetState();
}

class _MedicaminaDashEdictsScriptsWidgetState extends State<MedicaminaDashEdictsScriptsWidget> {
  final eScripts = ['', ''];
