...
class MedicaminaDashFitnessDesktopWidget extends StatefulWidget {
  const MedicaminaDashFitnessDesktopWidget({Key? key}) : super(key: key);

  @override
  State<MedicaminaDashFitnessDesktopWidget> createState() => _MedicaminaDashFitnessDesktopWidget();
}

class _MedicaminaDashFitnessDesktopWidget extends State<MedicaminaDashFitnessDesktopWidget> {
                                              ...
                                              child: Material(
                                                child: InkWell(
                                                  ...
                                                  child: Column(
                                                    mainAxisAlignment: MainAxisAlignment.center,
                                                    children: const [
                                                      Icon(CommunityMaterialIcons.dumbbell, size: 66),
                                                      SizedBox(height: 2),
