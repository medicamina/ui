...
class _MedicaminaDashHomeTableWidget extends State<MedicaminaDashHomeTableWidget> {
...
class ResultsData extends DataTableSource {
  ...
  final List<Map<String, dynamic>> _data = [
    ...
    {
      "condition": "Aortic arch anomaly - peculiar facies - intellectual disability",
      "risk": "High",
      "alt_names": [],
      "conditon_id": "",
    },
    ...
    {
      "condition": "Cerebral dysgenesis-neuropathy-ichthyosis-keratoderma syndrome (CEDNIK)",
      "risk": "Medium",
      "alt_names": [],
      "conditon_id": "",
    },
    ...
    {
      "condition": "Congenital muscular dystrophy-infantile cataract-hypogonadism syndrome",
      "risk": "Medium",
      "alt_names": [],
      "conditon_id": "",
    },
    ...
    {
      "condition": "Crouzonodermoskeletal syndrome (Crouzon syndrome with acanthosis nigricans)",
      "risk": "Low",
      "alt_names": [],
      "conditon_id": "",
    },
    ...
    {
      "condition": "Hereditary hemorrhagic telangiectasia(Osler-Weber-Rendu syndrome)",
      "risk": "High",
      "alt_names": [],
      "conditon_id": "",
    },
    ...
    {
      "condition": "Hereditary spastic paraplegia (infantile-onset ascending hereditary spastic paralysis)",
      "risk": "High",
      "alt_names": [],
      "conditon_id": "",
    },
    ...
    {
      "condition": "Hereditary neuropathy with liability to pressure palsies (HNPP)",
      "risk": "Low",
      "alt_names": [],
      "conditon_id": "",
    },
    ...
    {
      "condition": "Immunodeficiency-centromeric instability-facial anomalies syndrome (ICF syndrome)",
      "risk": "Medium",
      "alt_names": [],
      "conditon_id": "",
    },
    ...
    {
      "condition": "Infantile cerebral and cerebellar atrophy with postnatal progressive microcephaly",
      "risk": "Medium",
      "alt_names": [],
      "conditon_id": "",
    },
    ...
    {
      "condition": "Skin fragility-woolly hair-palmoplantar keratoderma syndrome",
      "risk": "Medium",
      "alt_names": [],
      "conditon_id": "",
    },
    ...
    {
      "condition": "Strudwick syndrome (spondyloepimetaphyseal dysplasia, Strudwick type)",
      "risk": "Low",
      "alt_names": [],
      "conditon_id": "",
    },
    ...
    {
      "condition": "X-linked intellectual disability and macroorchidism (fragile X syndrome)",
      "risk": "Low",
      "alt_names": [],
      "conditon_id": "",
    },
    {
      "condition": "X-linked spinal-bulbar muscle atrophy (spinal and bulbar muscular atrophy)",
      "risk": "Low",
      "alt_names": [],
      "conditon_id": "",
    },
